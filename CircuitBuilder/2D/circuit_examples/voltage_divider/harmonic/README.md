...
```
Include "harmonic_voltage_divider.definition"
```
...
```
$ ElmerSolver harmonic_volt_divider_wire.sif
```
...
```
$ mpirun -np 3 ElmerSolver_mpi harmonic_volt_divider_wire.sif
```
