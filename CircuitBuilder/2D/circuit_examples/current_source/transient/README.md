...
```
Include "DC_current_source.definition"
```
...
```
$ ElmerSolver transient_current_wire.sif
```
...
```
$ mpirun -np 3 ElmerSolver_mpi transient_current_wire.sif
```
