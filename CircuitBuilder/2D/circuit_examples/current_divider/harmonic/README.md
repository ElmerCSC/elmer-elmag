...
```
Include "harmonic_current_divider.definition"
```
...
```
$ ElmerSolver harmonic_currentdiv_wire.sif
```
...
```
$ mpirun -np 3 ElmerSolver_mpi harmonic_currentdiv_wire.sif
```
