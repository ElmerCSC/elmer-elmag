...
```
Include "transient_current_divider.definition"
```
...
```
$ ElmerSolver transient_currentdiv_wire.sif
```
...
```
$ mpirun -np 3 ElmerSolver_mpi transient_currentdiv_wire.sif
```
