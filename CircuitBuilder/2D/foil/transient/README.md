...
```
$ ElmerSolver 1383-components-foilwinding.sif
```
...
```
ElmerGrid 2 2 1383 -partdual -metiskway 3
```
...
```
$ mpirun -np 3 ElmerSolver_mpi 1383-components-foilwinding.sif
```
