...
def main(argv=None):
    ...
    # name output file
    output_file = "transient_current_divider.definition"

    # initialize circuits: number of circuits - do not remove
    c = number_of_circuits(1)

    # ------------------------------------------Circuit 1 ------------------------------------------------
    # ---------------(Current Divider - Steady State /  Modify Body Force 1 in file for Transient )---------------------
    ...
    c[1].components.append([I1, R1, FEM_Component1])
