# 3D Open Massive Coil - Transient
...
```
Include "transient_open3Dmassive_circuit.definition"
```
...
```
$ ElmerSolver transient_open_wire.sif
```
...
```
$ mpirun -np 3 ElmerSolver_mpi transient_open_wire.sif
```
