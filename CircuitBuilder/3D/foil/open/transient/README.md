# 3D Open Foil Winding - Transient
...
```
Include "6459-transient_open3Dfoil_circuit.definition"
```
...
```
ElmerGrid 2 2 6479 -partdual -metiskway 3
```
...
```
$ mpirun -np 3 ElmerSolver_mpi 6479.sif
```
